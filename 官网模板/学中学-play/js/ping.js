...
function b() {
    ...
    function reply(box) {
        ...
        var html = '<div class="comment-left">' + '<img src="img/2.jpg" alt=""/>' + '</div>' +
    ...
    function praiseReply(el) {
        ...
        if (my == 0) {
            ...
            el.innerHTML = " <img src='img/xzx-play-zan02.png'/><br/>" + newtotal;
        } else {
            //反之-1
            newtotal = total - 1;
            el.setAttribute("total", newtotal);
            el.setAttribute("my", 0);
            el.innerHTML = " <img src='img/xzx-play-zan01.png'/><br/>" + newtotal;
        }
    }
    //操作回复
